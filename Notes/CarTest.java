...
public class CarTest
{
    ...
    public void testGetGasInTank()
    {
        ...
        /*
         * the JUnit assertEquals method tests two values and fails the test
         *      if they are not equal
         * specify the expected value first and the calculated value second
         * 
         * for doubles, speciy a third paraemeter which is the epsilon value
         *      epsilon specifies how close is close enough to be considered
         *      equal.
         */
        assertEquals( 0.0, amount, 1e-6 /* 1 x 10^-6 */ );
    }
